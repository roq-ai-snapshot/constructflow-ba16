        ...
        ? [
            ...
            },
            {
              ...
              content: (
                <>
                  <Text>
                    {`Currently, you are not logged in. The best way to begin your journey is by signing up as an Owner and creating your first ${tenantName}. Click on "Done" and then select "Register as Owner".`}
                  </Text>
                </>
              ),
              target: '.roles-container',
